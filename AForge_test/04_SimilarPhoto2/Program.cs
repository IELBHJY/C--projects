...
namespace _04_SimilarPhoto2
{
    class Program
    {
        public static Bitmap Resize(string imageFile)
        {
        ...
        {
            Bitmap bm1 = Resize(@"E:\复杂机电\单目标定图片\000000.bmp");
            Bitmap bm2 = Resize(@"E:\复杂机电\单目标定图片\000000.bmp");
            int[] first = GetHisogram(bm1);
            int[] second = GetHisogram(bm2);
            float result = GetResult(first, second);
